...
class CusDatasetCPI(Dataset):
    ...
    def __init__(self, smiles_txt_path, device='cuda:0', transform=None, dataname = None, 
        processed_fold_name = None, protein_pdb_fold = None, res_dis = None,**kwargs):
        self.data_name1 = dataname
        self.protein_pdb_fold = protein_pdb_fold
        self.res_dis = torch.load(res_dis)
        self.processed_fold_name = processed_fold_name
